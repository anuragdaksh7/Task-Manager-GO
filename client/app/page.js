  ...
  return (
    <div>
      ...
      <div className=" px-10 md:px-20 lg:px-40 py-6 flex flex-col gap-2">
        ...
        <h1 className="text-md md:text-lg font-semibold pb-1 text-gray-600">
          Get Ahead of the crowd with TaskIt
        </h1>
        <p className="text-sm md:text-md font-bold px-3 rounded-md border-black py-1 border-[1px] w-fit">
          Comes with AI✨
        </p>
      </div>
      <SignedIn>
        <Link href={"/create-task"}>
          <div className=" absolute px-2 cursor-pointer py-1 z-10 bottom-[20px] right-[40px] border-[1px] border-black rounded-full scale-150">
